  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="contact3.php">Contact us</a>
        </li>
      </ul>
    </div>
  </div>
        ...
        <div class="container">
          <h1 style="text-align:center">Register in</h1>
            <p></p>
            <div class="contact-box">
                <div class="contact-left">
                      <h3>Sent your request</h3>
                    <form class="form-signin" action="contact2.php" method="POST">
            ...
            <div class="contact-right">
                ...
                <table>
                    <tr>
                        <td><a href="contact3.php"><i class="far fa-envelope"></i>Email:-
saraswatimodernschoolpsw@gmail.com
</a></td>
                    </tr>
                    
                    <tr>
                        <td><a href="contact3.php"><i class="fas fa-phone"></i>Phone:-
+91-161-2970656
</td>
                    </tr>       
                    </table>
...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($conn,"insert into signin(name,password,phone_no,email)values('$name','$password','$phone_no', '$email')");
   // var_dump($query);
    if($query){
